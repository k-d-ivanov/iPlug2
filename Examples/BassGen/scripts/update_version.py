...
def main():
  ...
  plistpath = scriptpath + "/resources/BassGen-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BassGen-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BassGen-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BassGen-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BassGen-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BassGen.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BassGen.iss",inplace=1):
