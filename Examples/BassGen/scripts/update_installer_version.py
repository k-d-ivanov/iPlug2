...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=BassGen Demo Installer\n"
      else:
        line="OutputBaseFilename=BassGen Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the BassGen Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the BassGen installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=BassGen Demo installer\n"
     else:
       line="SetupWindowTitle=BassGen installer\n"
