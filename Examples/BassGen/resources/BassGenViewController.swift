/*
  This is the initial ios app extension view controller, which is referenced by BassGen-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class BassGenViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in BassGen-iOS-MainInterface.storyboard to custom class: GenericUI  module: BassGenFramework
